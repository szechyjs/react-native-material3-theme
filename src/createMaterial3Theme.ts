...
import type { Material3Scheme, Material3Theme, SystemScheme } from './types';
...
export function createThemeFromSystemSchemes(schemes: {
  ...
  return {
    light: {
      ...schemes.light,
      ...generateMissingFields(schemes.light, palettes, 'light'),
    } as Material3Scheme,
    dark: {
      ...schemes.dark,
      ...generateMissingFields(schemes.dark, palettes, 'dark'),
    } as Material3Scheme,
  };
}
